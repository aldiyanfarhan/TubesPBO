...
//                                      MEMBER SECTION
    ...
    public void loadMember(){
        ...
        try {
            rs = stmt.executeQuery(query);
            while (rs.next()){
                member.add(new Member(rs.getString("id_member"), 
    ...
    public void addMember(Member m){
        connect();
        String query = "INSERT INTO member(Nama, Email, Alamat, NoTelp) VALUES (";
    ...
    public boolean cekDuplikatEmailMember(String Email){
        boolean cek = false;
        for (Member m : member) {
